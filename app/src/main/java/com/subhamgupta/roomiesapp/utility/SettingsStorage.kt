...
class SettingsStorage(private val context: Context) {
    ...
    var startDateOfMonth: String? = null
        get() {
            field = sharedPreferences.getString("startdate", "null")
            return field
        }
        set(value) {
    ...
    var startDateMillis: Long? = null
        get() {
            field = sharedPreferences.getLong("startmillis", 0)
            return field
        }
        set(value) {
            if (value != null) {
                editor.putLong("startmillis", value)
            }
            editor.commit()
            field = value
        }
    var roomRef: String?=null
        ...
        set(value) {
            editor.putString("room_ref", value)
            editor.commit()
            field = value
        }
